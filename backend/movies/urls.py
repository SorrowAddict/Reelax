...
urlpatterns = [
    ...
    path('genre-movies/', views.genre_movies),
    ...
    path('director/<int:director_id>/', views.director_detail),
    path('actor/<int:actor_id>/', views.actor_detail),
    path('like-movie/<int:movie_id>/', views.like_movie),
    path('like-director/<int:director_id>/', views.like_director),
    path('like-actor/<int:actor_id>/', views.like_actor),
    path('<int:movie_id>/reviews/', views.movie_reviews),
